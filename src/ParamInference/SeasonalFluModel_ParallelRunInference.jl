...
#Run in parallel & take arguments from command line as function inputs
...
#--------------------------------------------------------------------------
@everywhere include("../ModelFns/RunSeasonalFluModelODEs.jl")
@everywhere include("../ModelFns/ExpHistUpdate.jl")
@everywhere include("ABC_APMC/APMC_ParLoop.jl")
@everywhere include("SeasonalFluModel_ParallelInferenceFns.jl")
