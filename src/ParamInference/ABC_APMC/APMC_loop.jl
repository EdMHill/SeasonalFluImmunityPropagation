function APMC_loop(ObservedData,FirstGenFromFileFlag::Int64,N::Int64,alpha::Float64,N_alpha::Int64,
...
while (AcceptRate > MinAcceptRate) && (GenT < MaxGen)
    ...
    #----------------------------------------------------------------------
    PerturbedParamSets = zeros(N-N_alpha,ParamNum)
    for jj = 1:N-N_alpha #Resample out of range param. sets
